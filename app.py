...
class DataForm:
    """
    DataForm class to handle and process incoming form data.
    This class defines the vehicle-related attributes expected
    from the HTML form.
    """
    ...
    async def get_vehicle_data(self):
        """
        Retrieve form data and assign it to class attributes.
        """
...
async def index(request: Request):
    """
    Render the main vehicle insurance prediction form.
    """
...
async def predictRouteClient(request: Request):
    """
    Endpoint to receive form data and make a prediction.
    """
    ...
    try:
        ...
        # --------------------------------------------------------
        # IMPORTANT:
        # request is passed separately
        # name contains the template name
